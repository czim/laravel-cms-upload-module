...
abstract class CmsBootTestCase extends TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('cms-core.providers', [
            ...
            CmsUploadModuleServiceProvider::class,
    ...
    protected function mockBoundCoreExternalComponents($app)
    {
        $app->bind('mock-cms-auth', function () {
            ...
            $mock->method('admin')->willReturn(true);
            $mock->method('can')->willReturnCallback(function () { return true; });
            $mock->method('canAnyOf')->willReturnCallback(function () { return true; });

            // Mock the user itself
            $user = $this->getMockBuilder(UserInterface::class)->getMock();
            $user->method('getUsername')->willReturn('TestAdmin');
